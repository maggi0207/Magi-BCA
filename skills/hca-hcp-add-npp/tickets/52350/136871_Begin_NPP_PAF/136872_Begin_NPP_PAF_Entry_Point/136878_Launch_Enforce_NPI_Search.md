# 136878 â€” NPP: Launch existing Enforce NPI Search workflow
...
- Begin PAF search (`screenshots/Begin_PAF_Current`) is NPI + SSN + name â€” **different** screen.
- NPI-required search (`screenshots/NPP_Search/01_Enforce_NPI_Search_NPI_Required.png`) has NPI * and â€œNo NPI available? Search without NPIâ€.
- Chat note that PSG has this search and it may be used for MSP â€” supporting context only.
